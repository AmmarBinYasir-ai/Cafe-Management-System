...
-- Assuming you have a table named Cashier in your database
-- Columns: CashierID, StaffID, CashRegisterID, Email, Passcode

-- Query to authenticate the cashier and retrieve personal details
SELECT C.CashierID, S.StaffID, S.FirstName, S.LastName, S.Email, S.Phone, C.CashRegisterID
FROM Cashier C
JOIN Staff S ON C.StaffID = S.StaffID
WHERE S.Email = 'Ahmad.Raza@example.com' AND S.Passcode = '4321';
